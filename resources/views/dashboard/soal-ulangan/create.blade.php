...
@section('content')
<h2>Tambah File Soal Ulangan Baru</h2>

@include('partials.alerts')

<form action="{{ route('dashboard.soal-ulangan.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
        <label for="judul" class="form-label">Judul File Ulangan</label>
